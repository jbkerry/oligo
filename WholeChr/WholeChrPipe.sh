...
if [ -z "$Region" ]
then
    python /t1-data1/WTSA_Dev/jkerry/OligoDesign/WholeChr/OligoGen.py -g $Genome -c $Chr -e $Enzyme -o $Oligo
else
    python /t1-data1/WTSA_Dev/jkerry/OligoDesign/WholeChr/OligoGen.py -g $Genome -c $Chr -e $Enzyme -o $Oligo -r $Region
fi
